...
// Copyright ÂŠ 2012 Robert Gerlach - robsite.net
        ...
        encode(text) {
            ...
            for (let i in text) {
                ...
                if (this.options.top) {
                    ...
                    let diacriticsTopLength = this.diacriticsTop.length - 1;
                    let len = this.options.maxHeight - Math.random() * ((this.options.randomization / 100) * this.options.maxHeight);
                ...
                if (this.options.bottom) {
                    let diacriticsBottomLength = this.diacriticsBottom.length - 1;
                    let len = this.options.maxHeight - Math.random() * ((this.options.randomization / 100) * this.options.maxHeight);
                    for (let count = 0; count < len; count++) {
